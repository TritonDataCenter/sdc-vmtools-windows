Find this ISO at https://download.joyent.com/pub/vmtools/, named winsetup-*
Or on OSX make your own:
# EDIT: removed <ProductKey> XML tag from Autounattend.xml to make eval ISOs work (License Terms not found error)
...
RDP available via external NIC. If put only on admin NIC, use VNC with socat like this:
